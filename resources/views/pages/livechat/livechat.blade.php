            ...
            <div class="profile-desc">
              <div class="profile-pic">
                ...
                <div class="profile-name">
                  <h5 class="mb-0 font-weight-normal">Ajith</h5>
                  <span>CSE</span>
                </div>
              </div>
            </div>
              ...
              <li class="nav-item dropdown">
                <a class="nav-link" id="profileDropdown" href="#" data-bs-toggle="dropdown">
                  <div class="navbar-profile">
                    <img class="img-xs rounded-circle" src="/assets/images/faces/face15.jpg" alt="">
                    <p class="mb-0 d-none d-sm-block navbar-profile-name">Ajith</p>
                  </div>
                </a>
              </li>
              <li class="nav-item dropdown">
                  ...
                  <div class="card-body">
                    <h4 class="card-title" style="color: red">Let's Chat</h4>
                      ...
                      <div class="form-group">
                        <input hidden type="text" value="Ajith" id="username" name="username">
                        <input type="text" id="message_input" onclick="this.value=''" name="message" placeholder="enter message ...">
                      </div>
